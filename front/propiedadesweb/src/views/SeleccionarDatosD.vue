<template>
    <div class="seleccionar-depa">
      ...
      <div class="address-inputs">
        ...
        <input type="text" v-model="address.line2" placeholder="Valor en UF" />
        ...
        <input type="text" v-model="address.line3" placeholder="¿Cuál es el número de piso del departamento?" />
      </div>
